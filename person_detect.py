...
#         raise NotImplementedError
    ...
    def predict(self, image):
        ...
        outputs = self.net.infer({self.input_name: input_img})
...
#         raise NotImplementedError
    ...
    def draw_outputs(self, coords, image):
        ...
        boxes = []
        for coord in coords:
            box_1 = (int(coord[0] * width), int(coord[1] * height))
            box_2 = (int(coord[2] * width), int(coord[3] * height))
            boxes.append([box_1[0], box_1[1], box_2[0], box_2[1]])
            cv2.rectangle(image, box_1, box_2, (0, 255, 0), 3)
